...
set HB_WITH_CURL=C:\Users\<username>\dev\harbour-3.2.0dev-libs\curl-7.54.0-win32-mingw\include
set HB_WITH_FREEIMAGE=C:\Users\<username>\dev\harbour-3.2.0dev-libs\FreeImage3170Win32Win64\FreeImage\Dist\x32
