...
PROCEDURE Main()
   LOCAL aConfirm[5]            // 1-D dim'd LOCAL
   LOCAL aGrid[2][3]            // 2-D — only outer dim sized eagerly
   LOCAL nI
   ...
   ? "saTotals=" + Str( saTotals[ 1 ], 2 ) + "," + Str( saTotals[ 2 ], 2 ) + "," + Str( saTotals[ 3 ], 2 )
   ? "aConfirm=" + aConfirm[ 1 ] + "/" + aConfirm[ 5 ]
   ? "aGrid=" + aGrid[ 1 ][ 1 ] + aGrid[ 1 ][ 3 ] + "|" + aGrid[ 2 ][ 2 ]
RETURN
